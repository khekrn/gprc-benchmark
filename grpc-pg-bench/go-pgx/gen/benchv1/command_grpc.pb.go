...
//
// CommandService models the minimal hot path of a workflow engine:
// receive a command, do a tiny amount of CPU work, persist it, return the id.
type CommandServiceClient interface {
	// Execute unmarshals the request, performs small processing, inserts one
	// row into Postgres, and returns the generated id.
